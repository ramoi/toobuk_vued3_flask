"""
Django settings for statist project.
...
# FRONTEND_DIR = os.path.join (BASE_DIR, '../../vue/chart')
...
#         'STATS_FILE': os.path.join(TEMPLATES_DIR, 'webpack-stats.json'),
#     }
# }